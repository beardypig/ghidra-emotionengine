 ...
 */
 ...
 // MipsAddressAnalyzer modified for use with ghidra-emotionengine
...
public class MipsR5900AddressAnalyzer extends ConstantPropagationAnalyzer {
	...
	private String[] strLoadStore = { "addiu", "daddiu", "lw", "_lw", "ld", "_ld", "lq", "_lq",
		"sw", "_sw", "sh", "_sh", "sd", "_sd", "sq", "_sq", "lbu", "lhu" };
	...
	private final static String PROCESSOR_NAME = "MIPS-R5900";

	public MipsR5900AddressAnalyzer() {
